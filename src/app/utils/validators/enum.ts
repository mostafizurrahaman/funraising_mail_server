 ...
 */
export const enumString = <T extends readonly string[]>(
   values: T,
   fieldName = "Value",
) =>
   z.enum(values, {
 ...
 * @param fieldName - Field name for error messages
 */
export const optionalEnumString = <T extends readonly string[]>(
   values: T,
   fieldName = "Value",
 ...
 * @param fieldName - Field name for error messages
 */
export const nullableEnumString = <T extends readonly string[]>(
   values: T,
   fieldName = "Value",
