...
const getAvailableRides = catchAsync(async (req, res) => {
   const result = await DriverPortalServices.getAvailableRides(String(req.user._id));
...
const acceptRide = catchAsync(async (req, res) => {
   const result = await DriverPortalServices.acceptRide(String(req.user._id), req.params.id as string);
...
const releaseRide = catchAsync(async (req, res) => {
   const result = await DriverPortalServices.releaseRide(String(req.user._id), req.params.id as string);
